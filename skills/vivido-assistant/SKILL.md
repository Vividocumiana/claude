...
2. Invia con `send.sh U062MREADAB` (MAI `D0634QNLF52`: il bot non la vede, vedi nota sopra).
...
5. Invia con `send.sh` a `U062MREADAB` (MAI `D0634QNLF52`: canale diverso, il bot risponde `channel_not_found`).
