...
2. `bash ~/.claude/skills/vivido-assistant/send.sh U062MREADAB /tmp/vivido-assistant-weekly.md` (DM bot ↔ Samuele; MAI `D0634QNLF52`, il bot non la vede → `channel_not_found`).
3. Fallback `send.sh U062MREADAB` se fallisce.
